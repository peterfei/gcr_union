...
describe "self_drive_prices/new" do
  before(:each) do
    assign(:self_drive_price, stub_model(SelfDrivePrice,
      :weekday => "9.99",
      :weekend => "9.99",
      :car_model => nil,
      :location => nil,
  ...
  it "renders new self_drive_price form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", self_drive_prices_path, "post" do
